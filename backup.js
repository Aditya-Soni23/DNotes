...
personalFilter.onclick = () => currentFilter = "personal";
professionalFilter.onclick = () => currentFilter = "professional";
onValue(notesRef, snapshot => {
  notesList.innerHTML = "";
  ...
  notes.forEach(data => {
    ...
    li.innerHTML = `
      ...
      <div class="note-time">${data.reminder || ""}</div>
    `;
